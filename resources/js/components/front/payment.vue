  ...
  <div>
    <div class="ladiui tab-pane fade show open">
      <div class="ladiui form-group customer-tab">
        <label class="ladiui checkout-title-text">Phương thức thanh toán</label>
      ...
      <div class="ladiui form-group customer-tab">
        <div class="payment-title-info">
          <label class="ladiui checkout-title-text">Thông tin người nhận</label
          ><span class="ladiui link cursor-pointer mt-24">Chỉnh sửa</span>
        </div>
        <div>
          <div class="mb-8"><span>dũng</span><span> - 0965346910</span></div>
          <div>
            <span>grgwrw</span
            ><span>, Xã Vĩnh Tân, Thị xã Tân Uyên, Bình Dương</span>
          </div>
        </div>
      </div>
      <div class="ladiui form-group customer-tab">
        <div class="payment-title-info">
          <label class="ladiui checkout-title-text">Thông tin đơn hàng</label
          ><span class="ladiui link cursor-pointer mt-24">Chỉnh sửa</span>
        </div>
        <div>
          <div class="item-cart">
      ...
      <div class="ladiui coupon-group">
        <label class="checkout-title-option">Mã giảm giá</label>
        <div class="flex-center-between">
          <input
            class="ladiui input-discount"
            placeholder="Nhập mã giảm giá"
            value=""
          /><button class="ladiui btn-apdung" disabled="">Áp dụng</button>
        </div>
      </div>
      ...
      <div class="p-0-16">
        ...
        <div class="ladiui invoice-info hide">
          ...
          <div class="pos-rel mt-16">
            <span class="ladiui label-sub">Email nhận hoá đơn</span
            ><input
              class="ladiui form-control"
              name="billing_email"
          ...
          <div class="pos-rel mt-16">
            <span class="ladiui label-sub">Mã số thuế</span
            ><input
              class="ladiui form-control"
          ...
          <div class="pos-rel mt-16">
            <span class="ladiui label-sub">Địa chỉ công ty</span
            ><input
              class="ladiui form-control"
