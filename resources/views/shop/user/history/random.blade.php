...
@section('seo')
<title>Lịch sử mua random - {{config('global.app_name')}}</title>
<meta name="description" content="Mua acc free fire giá rẻ chất lượng uy tín." />
@endsection

@section('js')
<script src="/shop_assets/js/random/fb-2fa.js"></script>
@endsection
                        ...
                        <div class="sa-lpmain">
                            <div class="sa-lsnmain clearfix">
                                <div class="c-content-title-1">
                                    <h3 class="c-font-uppercase c-font-bold">Lịch Sử Random</h3>
