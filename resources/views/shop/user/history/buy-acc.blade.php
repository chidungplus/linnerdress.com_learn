...
@section('seo')
<title>Lịch sử mua acc - {{config('global.app_name')}}</title>
<meta name="description" content="Mua acc free fire giá rẻ chất lượng uy tín." />
@endsection

@section('js')
<script src="/shop_assets/js/freefire/fb-2fa.js"></script>
@endsection
                        ...
                        <div class="sa-lpmain">
                            <div class="sa-lsnmain clearfix">
                                <div class="c-content-title-1">
                                    <h3 class="c-font-uppercase c-font-bold">Lịch Sử Mua Acc</h3>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-primary">{{$row->password}}</td>
                                                <td class="text-primary"><span class="btn btn-success btn-sm" onclick="getFbCode({{$row->id}});">Lấy mã</span></td>
                                                <td class="text-primary">{{number_format($row->price)}}<sup>đ</sup></td>
                                                <td class="text-primary">{{$row->getLoaiNick}}</td>
                                                <td class="text-primary" style="color:#0ce2ab">{{$row->getLogin}}</td>
