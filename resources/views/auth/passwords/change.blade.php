                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('changePassword') }} ">
                        ...
                        <div class="form-group{{ $errors->has('new-password') ? ' has-error' : '' }} row">
                            ...
                            <div class="col-md-6">
                                <input id="new-password" type="password" class="form-control" name="new-password" required aria-autocomplete="list" autocomplete="new-password">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="new-password-confirm" type="password" class="form-control" name="new-password_confirmation" required aria-autocomplete="list" autocomplete="new-password">
