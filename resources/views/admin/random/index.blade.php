...
@section('js')
<script src="/admin_assets/js/random/index.js"></script>
<script src="/admin_assets/js/random/search.js"></script>
@endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-inline">
                        <h3 class="card-title"><a href="/admin/random/create" class="btn btn-success btn-sm"> <i
