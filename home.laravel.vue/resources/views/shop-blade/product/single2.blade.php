                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 info-sp">
                        ...
                        {{-- <div class="mo_ta_ngan">
                            <p>✔ Linner Dress , Thương hiệu Váy, Đầm dạ hội đẹp, độc, nhiều mẫu mã đa dạng, sẽ mang
                        ...
                        <div class="muahang">
                            <div class="quantity">
                                <input type="number" step="1" min="1" max="5" name="quantity"
                                    value="1" title="SL" class="input-text qty text" size="4" pattern="[0-9]*"
                                    id="quantity" disabled>
                                </div>
                            {{-- 
                                <div class="button_mua mua_ngay">
                                <div class="wp_cart_button_wrapper dangky" onclick="buyNow({{$product->id}});">Mua ngay
                                </div>

                                
                            </div>

                            <a href="" onclick="buyNow({{$product->id}});"> <button type="button" class="dangky"
                                        >Mua ngay</button> </a> --}}
