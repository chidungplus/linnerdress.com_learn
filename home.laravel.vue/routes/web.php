...
Route::middleware(['auth','admin'])->namespace('Admin')->prefix('admin')->group(function () {
    ...
    Route::prefix('product')->group(function () {
        Route::get('/{acc_id}/product-item', 'ProductController@productItem');
        Route::post('/{acc_id}/product_item', 'ProductController@storeProductItem');
    ...
    Route::get('/product-item/{product_item_id}/gallery','ProductItemController@gallery');

    Route::post('/gallery/{gallery_id}/image','GalleryController@handleImage');
...
// });
Route::namespace('Frontend')->prefix('html')->group(function () {
    Route::view('/', 'home.index')->name('html');
    Route::view('/single', 'home.single')->name('html.single');
});

#Fontend
Route::namespace('Frontend')->group(function () {
    Route::view('/{path?}', 'vue')
    ->where('path', '^(?!storage|images).*')
    ->name('vue');
});